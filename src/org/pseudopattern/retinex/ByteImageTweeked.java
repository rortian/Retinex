...
public class ByteImageTweeked {
    ...
    public ByteImageTweeked(BufferedImage inputImage, HashMap<String, Number> options) {
        ...
        for(int i=0;i<3;i++)
            ...
            Logger.getLogger(ByteImageTweeked.class.getName()).log(Level.SEVERE, null, ex);
        }
